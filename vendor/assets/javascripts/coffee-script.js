...
(function() {
  ...
  syntaxErrorToString = function() {
    var codeLine, end, filename, first_column, first_line, last_column, last_line, marker, ref2, start;
...
// Generated by CoffeeScript 1.9.1
(function() {
  var $, BOM, CLOSING_TAG, COMMENT, HEREDOC, HEREGEX, JSTOKEN, OPENING_TAG, PRAGMA, ParseTreeBranchNode, ParseTreeLeafNode, Parser, REGEX, SIMPLESTR, TAG_ATTRIBUTES, TRAILING_SPACES, WHITESPACE, compact, count, last, ref, repeat, starts, throwSyntaxError;

  ref = require('./helpers'), count = ref.count, starts = ref.starts, compact = ref.compact, last = ref.last, repeat = ref.repeat, throwSyntaxError = ref.throwSyntaxError;
  ...
  module.exports = Parser = (function() {
    ...
    Parser.prototype.parse = function(code, opts) {
      ...
      while ((this.chunk = code.slice(i))) {
        ...
        consumed = ((ref1 = this.currentState()) !== $.CJSX_EL && ref1 !== $.CJSX_ATTRIBUTES ? this.csComment() || this.csHeredoc() || this.csString() || this.csRegex() || this.jsEscaped() : void 0) || this.cjsxStart() || this.cjsxAttribute() || this.cjsxEscape() || this.cjsxUnescape() || this.cjsxEnd() || this.cjsxText() || this.coffeescriptCode();
...
},{"./helpers":2,"./symbols":7}],5:[function(require,module,exports){
// Generated by CoffeeScript 1.9.1
(function() {
  var $, HTML_ELEMENTS, SPACES_ONLY, Serialiser, TEXT_LEADING_WHITESPACE, TEXT_TRAILING_WHITESPACE, WHITESPACE_ONLY, containsNewlines, entityDecode, exports, find, firstNonWhitespaceChild, genericBranchSerialiser, genericLeafSerialiser, joinList, last, nodeSerialisers, ref, serialise, stringEscape;
  ...
  Serialiser = (function() {
    ...
    Serialiser.prototype.serialiseSpreadAndPairAttributes = function(children) {
      var accumulatedWhitespace, assignIndex, assignItem, assigns, assignsWithWhitespace, child, childIndex, flushPairs, j, k, lastAssignWithWhitespace, len, len1, pairAttrsBuffer, ref1;
      assigns = [];
      pairAttrsBuffer = [];
...
},{"./entitydecode":1,"./helpers":2,"./htmlelements":3,"./stringescape":6,"./symbols":7}],6:[function(require,module,exports){
...
},{"./parser":4,"./serialiser":5}],9:[function(require,module,exports){
// Generated by CoffeeScript 1.9.1
(function() {
  var Lexer, compile, formatSourcePosition, helpers, lexer, parser, sourceMaps, withPrettyErrors;
  ...
  exports.compile = compile = withPrettyErrors(function(code, options) {
    var currentColumn, currentLine, extend, fragment, fragments, header, i, js, len, merge, token, tokens;
...
},{"./helpers":10,"./lexer":11,"./nodes":12,"./parser":13}],10:[function(require,module,exports){
// Generated by CoffeeScript 1.9.1
(function() {
  ...
  syntaxErrorToString = function() {
    var codeLine, end, filename, first_column, first_line, last_column, last_line, marker, ref1, start;
    if (!(this.code && this.location)) {
      return Error.prototype.toString.call(this);
    }
...
},{"./helpers":10,"./rewriter":14}],12:[function(require,module,exports){
// Generated by CoffeeScript 1.9.1
(function() {
...
},{"./helpers":10,"./lexer":11,"./scope":15}],13:[function(require,module,exports){
...
},{"./coffee-react-transform/transformer":8,"./coffee-script/coffee-script":9}]},{},[16]);
